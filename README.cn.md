...
[![x-cmd/install — pastel Code Quality Monitoring Repo Card](https://repo.x-cmd.io/pastel.svg?lang=zh)](https://x-cmd.com/install/pastel)
...
合计: **6,084** 行代码（覆盖前 5 种语言、共 **44** 个文件）。
...
- **上游仓库**: <https://github.com/sharkdp/pastel>
- **许可证**: Apache-2.0
...
- **Star**: 6,499 · **Fork**: 133 · **开放 issue**: 141 · **贡献者**: 43

## 累计统计

- **发布数**: 15 · **已合并 PR**: 115 · **开放 PR**: 14 · **已关闭 issue**: 116 · **开放 issue**: 25 · **提交数**: 541
...
| last60d | 2026-07-22 | 0 | 0 | 5 | 0 | 0 | 0 |
| 90d | 2026-06-22 | 0 | 0 | 5 | 0 | 0 | 0 |
| last180d | 2026-03-24 | 0 | 0 | 13 | 0 | 1 | 0 |
| 360d | 2025-09-25 | 2 | 19 | 13 | 5 | 6 | 24 |
| last720d | 2024-09-30 | 2 | 36 | 14 | 12 | 7 | 52 |
...
pastel 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `pastel` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/pastel.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260920.yml` · 2026-09-20T04:58:06Z._
